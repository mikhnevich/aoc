...
public class D22J {
    ...
    private static int solve(List<String> s, boolean hard) {
        ...
        PriorityQueue<Wizard> wizards = new PriorityQueue<Wizard>((a, b) -> Integer.compare(b.mana_spend, a.mana_spend));
    ...
    public static void main(String[] args) throws IOException {
        List<String> s = Arrays.asList("Hit Points: 71", "Damage: 10");
